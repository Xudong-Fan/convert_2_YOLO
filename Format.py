...
class YOLO:
    ...
    def save(self, data, save_path, img_path, img_type, records_path):
        ...
        try:
            ...
            with open(os.path.abspath(os.path.join(records_path, "records.txt")), "w") as records_file:

                for key in data:
                    records_file.write(os.path.abspath(os.path.join(img_path, "".join([key, img_type, "\n"]))))
